...
namespace TMDbLibTests.Core2
{
    public class ClientFindTests : TestBase
    {
        ...
        public void TestFindImdbPerson()
        {
            ...
            IgnoreMissingCSharp("person_results[array].gender / gender", "person_results[array].known_for_department / known_for_department");
        ...
        {
            IgnoreMissingCSharp("tv_episode_results[array].overview / overview", "tv_episode_results[array].production_code / production_code");
        ...
        {
            IgnoreMissingCSharp("tv_episode_results[array].overview / overview", "tv_episode_results[array].production_code / production_code", "tv_season_results[array].episode_count / episode_count", "tv_season_results[array].overview / overview");
